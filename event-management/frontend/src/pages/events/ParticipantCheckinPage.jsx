      ...
      <div style={{ maxWidth: 480, margin: '40px auto', padding: '0 16px' }}>
        {success ? (
          <Result
            ...
            title={<span style={{ fontFamily: 'Inter', sans-serif, fontWeight: 700 }}>Tham gia sự kiện thành công!</span>}
          ...
          <Card style={{ borderRadius: 16, boxShadow: '0 4px 20px rgba(0,0,0,0.05)' }} bodyStyle={{ padding: '32px 24px', textAlign: 'center' }}>
            ...
            <Title level={3} style={{ fontFamily: 'Inter', sans-serif, marginBottom: 8 }}>
              Check-in Sự Kiện
            </Title>
