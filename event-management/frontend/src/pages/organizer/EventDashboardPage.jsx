      ...
      <div style={{ background: 'linear-gradient(135deg,#0f1629,#1a2744)', padding: '32px 24px', color: 'white' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', gap: 20, alignItems: 'center' }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <Title level={2} style={{ color: 'white', margin: 0, fontFamily: 'Arial, Helvetica, sans-serif' }}>{event.Title}</Title>
          </div>
      ...
      <div style={{ maxWidth: 1200, margin: '24px auto', padding: '0 24px', minHeight: '60vh' }}>
        <Row gutter={[24, 24]}>
          ...
          <Col xs={24} md={18} lg={19}>
            {activeMenu === 'overview' && (
              <div>
                <Title level={4} style={{ fontFamily: 'Arial, Helvetica, sans-serif', marginBottom: 24 }}>Thống kê sự kiện</Title>
                <Row gutter={[16, 16]}>
                  <Col xs={24} sm={8}>
                    <Card style={{ borderRadius: 12, border: '1px solid #e2e8f0', background: '#f8fafc' }}>
                      <div style={{ fontSize: 13, color: '#64748b' }}>Tổng đăng ký</div>
                      <div style={{ fontSize: 28, fontWeight: 800, color: '#2563eb', fontFamily: 'Arial, Helvetica, sans-serif' }}>
                  ...
                  <Col xs={24} sm={8}>
                    <Card style={{ borderRadius: 12, border: '1px solid #e2e8f0', background: '#f8fafc' }}>
                      ...
                      <div style={{ fontSize: 28, fontWeight: 800, color: '#7c3aed', fontFamily: 'Arial, Helvetica, sans-serif' }}>
            ...
            {activeMenu === 'participants' && (
              <div>
                <Title level={4} style={{ fontFamily: 'Arial, Helvetica, sans-serif', marginBottom: 24 }}>Danh sách Người tham dự</Title>
                <Table 
            ...
            {activeMenu === 'staffs' && (
              <div>
                <Title level={4} style={{ fontFamily: 'Arial, Helvetica, sans-serif', marginBottom: 24 }}>Danh sách Staff (Được phân công bởi Admin)</Title>
                <Table 
                  columns={staffCols} 
