...
const TicketModal = ({ registration, onClose }) => {
  ...
  return (
    <Modal open={!!registration} onCancel={onClose} footer={null} width={400} centered
      title={<span style={{ fontFamily: 'Arial, Helvetica, sans-serif', fontWeight: 700 }}>🎟️ Vé sự kiện</span>}>
      <div style={{ textAlign: 'center' }}>
        ...
        <div style={{ background: '#fef3c7', border: '2px dashed #f59e0b', borderRadius: 12, padding: '16px 24px', marginBottom: 16 }}>
          ...
          <div style={{ fontFamily: 'Arial, Helvetica, sans-serif', fontSize: 40, fontWeight: 800, letterSpacing: 10, color: '#1a2744' }}>
          ...
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 8 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                <Text strong style={{ fontSize: 15, fontFamily: 'Arial, Helvetica, sans-serif', lineHeight: 1.3 }}>{reg.Title}</Text>
    ...
    <MainLayout>
      ...
      <div style={{ background: 'linear-gradient(135deg,#0f1629,#1a2744)', padding: '40px 24px 32px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <Title level={2} style={{ color: 'white', fontFamily: 'Arial, Helvetica, sans-serif', margin: '0 0 6px' }}>
            📅 Lịch của tôi
          </Title>
          ...
          <div style={{ position: 'sticky', top: 80, display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <Card style={{ borderRadius: 14 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                ...
                <Text strong style={{ fontFamily: 'Arial, Helvetica, sans-serif', fontSize: 15 }}>
