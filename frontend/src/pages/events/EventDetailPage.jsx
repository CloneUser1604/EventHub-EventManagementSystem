...
const EventDetailPage = ({ adminEventId = null, noLayout = false, defaultTab = "about" }) => {
  ...
  const handleWriteReviewClick = () => {
    ...
    setTimeout(() => {
      document
        .getElementById("event-tabs-container")
  ...
  const handleRegister = async () => {
    ...
    if (
      ...
      return message.warning(
        "Chỉ người dùng cá nhân, diễn giả hoặc staff mới có thể đăng ký tham gia sự kiện",
      );
    setRegistering(true);
    try {
      ...
      useEventStore.setState((state) => ({
        selectedEvent: {
          ...state.selectedEvent,
          RegisteredCount: (state.selectedEvent.RegisteredCount || 0) + 1,
        },
      }));
    } catch (err) {
          ...
          useEventStore.setState((state) => ({
            selectedEvent: {
              ...
              RegisteredCount: Math.max(
                0,
                (state.selectedEvent.RegisteredCount || 0) - 1,
              ),
            },
          }));
        } catch (err) {
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to top, rgba(15,22,41,0.95) 0%, rgba(15,22,41,0.5) 50%, transparent 100%)",
          }}
        />
        ...
        >
          ...
          >
            <span>
              ...
              {dayjs(event.StartDate).format("dddd, DD/MM/YYYY · HH:mm")}
            </span>
            <span>
                  ...
                  children: (
                    <div>
                      {event.Description ? (
                        ...
                        `}</style>
                          <div
                            className={`ql-editor custom-html-content ${isPastedHTML ? "is-html" : ""}`}
                            style={{
                              padding: 0,
                              fontSize: 15,
                              lineHeight: 1.8,
          ...
          <div style={{position: "sticky", top: 80}}>
            ...
            >
              ...
              <Descriptions
                ...
                size="small"
                styles={{
                  label: {color: "#6b7280", fontSize: 13, width: 100},
