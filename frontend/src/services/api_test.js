require('dotenv').config({ path: 'c:/Users/admin/Downloads/ems-authentication-module/backend/.env' });
const { connectDB, getPool, closeDB, sql } = require('c:/Users/admin/Downloads/ems-authentication-module/backend/config/db');
